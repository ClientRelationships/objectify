...
var ConverterSerialiser = (function () {
    ...
    ConverterSerialiser.prototype.fromRaw = function (object) {
        ...
        return new Converter_1["default"](id, object.name, object.grabber, object.explainer, object.persuader, object.imageUrl, object.forwardUrl, object.callToAction, object.deepProfileOnSubmit, object._links);
    };
